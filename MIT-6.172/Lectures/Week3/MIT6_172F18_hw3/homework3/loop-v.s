...
.LBB0_2:                                #   Parent Loop BB0_1 Depth=1
	...
	movdqa	8240(%rsp,%rax,4), %xmm1
	movdqa	8256(%rsp,%rax,4), %xmm2
	movdqa	8272(%rsp,%rax,4), %xmm3
	paddd	12320(%rsp,%rax,4), %xmm0
	paddd	12336(%rsp,%rax,4), %xmm1
	movdqa	%xmm0, 4128(%rsp,%rax,4)
	movdqa	%xmm1, 4144(%rsp,%rax,4)
	paddd	12352(%rsp,%rax,4), %xmm2
	paddd	12368(%rsp,%rax,4), %xmm3
	movdqa	%xmm2, 4160(%rsp,%rax,4)
	movdqa	%xmm3, 4176(%rsp,%rax,4)
	addq	$16, %rax
	jne	.LBB0_2
