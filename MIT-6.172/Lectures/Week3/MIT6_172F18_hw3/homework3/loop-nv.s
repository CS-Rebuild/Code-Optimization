...
.LBB0_2:                                #   Parent Loop BB0_1 Depth=1
	...
	movl	8224(%rsp,%rax,4), %ecx
	movl	8228(%rsp,%rax,4), %edx
	addl	12320(%rsp,%rax,4), %ecx
	movl	%ecx, 4128(%rsp,%rax,4)
	addl	12324(%rsp,%rax,4), %edx
	movl	%edx, 4132(%rsp,%rax,4)
	movl	8232(%rsp,%rax,4), %ecx
	addl	12328(%rsp,%rax,4), %ecx
	movl	%ecx, 4136(%rsp,%rax,4)
	movl	8236(%rsp,%rax,4), %ecx
	addl	12332(%rsp,%rax,4), %ecx
	movl	%ecx, 4140(%rsp,%rax,4)
	addq	$4, %rax
	jne	.LBB0_2
